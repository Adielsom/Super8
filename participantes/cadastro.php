...
<body>
    ...
    <main class="container">
        <h1 class="header-title">Participantes</h1>
            ...
            <form id="formCadastro">
                <?php for ($i = 1; $i <= 8; $i++): ?>
                    <div class="form-group">
                        ...
                        <input type="text" id="jogador<?= $i ?>" name="jogadores[]" placeholder="Nome do atleta" required>
                    </div>
                <?php endfor; ?>
                <button type="submit">Avançar para Formato</button>
            </form>
            <div id="mensagem"></div>
        </div>
    </main>
